...
function DoctorDashboard() {
  ...
  const { currentUser, setCurrentUser, users, appointments, medicalRecords, prescriptions, notifications, messages, sendMessage, getConversation, updateAppointment, addPrescription, deletePrescription, addMedicalRecord, logout } = useApp();
              ...
              {profileLoading ? (
                ...
                <form onSubmit={handleProfileSubmit}>
                  ...
                  <div className="info-row">
                    ...
                    <input type="text" value={profileForm.specialty} onChange={(e) => setProfileForm({...profileForm, specialty: e.target.value})} required />
                  </div>
                  <div className="info-row">
                ...
                <>
                  ...
                  <div className="info-row">
                    <span className="info-label">Specialty</span>
                    <span className="info-value">{currentUser.specialty || 'Not set'}</span>
                  </div>
                  <div className="info-row">
                    <span className="info-label">Email</span>
                  ...
                  <div className="info-row">
                    ...
                    <span className="info-value">{currentUser.hospital || 'Not set'}</span>
                  </div>
