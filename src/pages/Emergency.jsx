...
function Emergency() {
  ...
  return (
    <div className="emergency-page">
      <Navbar />
      <div className="particles-placeholder" style={{position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', zIndex: -1, background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'}} />
