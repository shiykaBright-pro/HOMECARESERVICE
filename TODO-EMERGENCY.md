...
- [x] Step 4: Create /emergency route + Emergency.jsx page + dedicated CSS
- [x] Step 5: Update Home button to link to /emergency (removed hero, added to Navbar with styles)
- [x] Step 6: Add /emergency route to App.jsx
- [x] Step 7: Added prominent 🚨 Emergency link to Navbar (pulsing red style, mobile-optimized)
